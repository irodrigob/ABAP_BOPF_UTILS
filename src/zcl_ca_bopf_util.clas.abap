CLASS zcl_ca_bopf_util DEFINITION
  ...
  PROTECTED SECTION.
    ...
    "! <p class="shorttext synchronized">Fill values to structure BAPIRET2</p>
...
CLASS zcl_ca_bopf_util IMPLEMENTATION.
  ...
  METHOD conv_message_bopf_2_return.
    ...
    LOOP AT lt_messages ASSIGNING FIELD-SYMBOL(<ls_messages>).
      ...
      INSERT fill_return( iv_type       = COND #( WHEN lo_msg->severity IS NOT INITIAL THEN lo_msg->severity ELSE cs_message-error )
